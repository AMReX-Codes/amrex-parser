...
void
amrexpr_parser_delete (struct amrexpr_parser* parser)
{
...
void*
parser_allocate (struct amrexpr_parser* my_parser, std::size_t N)
{
...
void
parser_setconst (struct amrexpr_parser* parser, char const* name, double c)
{
...
void
parser_print (struct amrexpr_parser* parser)
{
...
std::set<std::string>
parser_get_symbols (struct amrexpr_parser* parser)
{
...
int
parser_depth (struct amrexpr_parser* parser)
{
